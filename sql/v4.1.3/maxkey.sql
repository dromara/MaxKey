...
CREATE TABLE `mxk_apps` (
  ...
  `PROTOCOL` varchar(45) DEFAULT NULL COMMENT '单点登录协议',
  ...
  `INDUCER` varchar(10) DEFAULT 'IDP' COMMENT '引导方式',
  `LOGOUTURL` varchar(300) DEFAULT NULL COMMENT '注销地址',
  `LOGOUTTYPE` tinyint DEFAULT NULL COMMENT '单点注销方式 0 NONE,1 BACK_CHANNEL,2 FRONT_CHANNEL',
  `INSTID` varchar(45) NOT NULL,
...
CREATE TABLE `mxk_history_login` (
  ...
  `INSTID` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `idx_mxk_hl_session_id` (`SESSIONID`)
