...
@Component({
  selector: 'app-access-editer',
  templateUrl: './access-editer.component.html',
  styleUrls: ['./access-editer.component.less']
})
export class AccessEditerComponent implements OnInit {
  ...
  fetch(): void {
    ...
    this.accessService.memberOut(this.query.params).subscribe(res => {
  ...
  onSubmit(e: MouseEvent): void {
    ...
    this.accessService.add({ groupId: this.groupId, appId: memberIds, appName: memberNames }).subscribe(res => {
      this.query.results = res.data;
      this.query.submitLoading = false;
      this.query.tableLoading = false;
      if (res.code == 0) {
