...
import { AccessEditerComponent } from './access-editer/access-editer.component';
...
export class AccessComponent implements OnInit {
  ...
  onAdd(e: MouseEvent): void {
    ...
    if (this.query.params.groupId !== '') {
      const modal = this.modalService.create({
        nzContent: AccessEditerComponent,
  ...
  fetch(): void {
    ...
    this.accessService.member(this.query.params).subscribe(res => {
