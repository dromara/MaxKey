...
@Component({
  selector: 'app-app-basic-details-editer',
  templateUrl: './app-basic-details-editer.component.html',
  styles: [
    `
      nz-tabset {
        width: 90%;
  ...
  styleUrls: ['./app-basic-details-editer.component.less']
})
export class AppBasicDetailsEditerComponent implements OnInit {
  @Input() id?: String;
  ...
  ngOnInit(): void {
    if (this.isEdit) {
      this.appsService.get(`${this.id}`).subscribe(res => {
