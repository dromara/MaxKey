...
@Component({
  selector: 'app-audit-connector',
  templateUrl: './audit-connector.component.html',
  styleUrls: ['./audit-connector.component.less']
})
export class AuditConnectorComponent implements OnInit {
  ...
  fetch(): void {
    ...
    this.historyService.fetchConnector(this.query.params).subscribe(res => {
