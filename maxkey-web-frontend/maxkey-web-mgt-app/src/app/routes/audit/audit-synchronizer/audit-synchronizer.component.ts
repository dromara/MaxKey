...
@Component({
  selector: 'app-audit-synchronizer',
  templateUrl: './audit-synchronizer.component.html',
  styleUrls: ['./audit-synchronizer.component.less']
})
export class AuditSynchronizerComponent implements OnInit {
  ...
  fetch(): void {
    ...
    this.historyService.fetchSynchronizers(this.query.params).subscribe(res => {
