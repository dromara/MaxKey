...
@Component({
  selector: 'app-audit-login-apps',
  templateUrl: './audit-login-apps.component.html',
  styleUrls: ['./audit-login-apps.component.less']
})
export class AuditLoginAppsComponent implements OnInit {
  query: {
    params: {
      username: String;
      displayName: String;
  ...
  fetch(): void {
    ...
    this.historyService.fetchLoginApps(this.query.params).subscribe(res => {
