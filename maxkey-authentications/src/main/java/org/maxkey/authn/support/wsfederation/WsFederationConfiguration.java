 ...
 * 
 * import org.opensaml.xml.security.x509.BasicX509Credential; import
 ...
 * 
 * @NotNull private String relyingParty;
 * 
 * private String upnSuffix;
 * 
 * @NotNull private List<Resource> signingCertificates;
 * 
 ...
 * 
 * public String getRelyingParty() { return relyingParty; }
 * 
 * public void setRelyingParty(String relyingParty) { this.relyingParty =
 * relyingParty; }
 * 
 * public List<BasicX509Credential> getSigningWallet() { return signingWallet; }
 * 
 ...
 *//**
	 ...
	 */
/*
 * public List<BasicX509Credential> getSigningCertificates() { return
 * this.signingWallet; }
 * 
 *//**
	 ...
	 */
/*
 * public void setSigningCertificates(final List<Resource>
 * signingCertificateFiles) { this.signingCertificates =
 * signingCertificateFiles;
 * 
 * final List<BasicX509Credential> signingCerts = new
 * ArrayList<BasicX509Credential>();
 * 
 ...
 *//**
	 ...
	 */
/*
 * public void setTolerance(final int tolerance) { this.tolerance = tolerance; }
 * 
 *//**
	 ...
	 */
/*
 * public WsFederationAttributeMutator getAttributeMutator() { return
 * attributeMutator; }
 * 
 *//**
	 ...
	 *//*
		 * public void setAttributeMutator(final WsFederationAttributeMutator
		 * attributeMutator) { this.attributeMutator = attributeMutator; }
		 * 
