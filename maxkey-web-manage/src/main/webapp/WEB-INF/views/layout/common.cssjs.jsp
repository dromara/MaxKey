...
<%@ taglib  prefix="s"  uri="http://sso.maxkey.org/tags" %>
	...
	<link   href="<s:Base/>/css/responsive.css"  type="text/css" rel="stylesheet"/>
	...
	<!-- form-4.2.2 -->
	<script src ="<s:Base/>/jquery/form-4.2.2/jquery.form.min.js" type="text/javascript" ></script>
	...
	<!-- metisMenu-v3.0.4 -->
	<link   href="<s:Base/>/jquery/metisMenu-v3.0.4/css/mm-vertical.css"  rel="stylesheet" >
	<link   href="<s:Base/>/jquery/metisMenu-v3.0.4/metisMenu.min.css"  rel="stylesheet" >
	<script src ="<s:Base/>/jquery/metisMenu-v3.0.4/metisMenu.min.js" type="text/javascript" ></script>
	<!-- common script start -->
	<script type="text/javascript">
		$(function () {
			...
			$.extend($.platform.messages, {
				window:		{title			:	'<s:Locale code="common.window.title" />'},
				alert:		{title			:	'<s:Locale code="common.alert.title" />',
							 closeText		:	'<s:Locale code="common.alert.closeText" />'},
				conform:	{title			:	'<s:Locale code="common.conform.title" />',
							 yes			:	'<s:Locale code="common.conform.yes" />',
							 no				:	'<s:Locale code="common.conform.no" />'},
				select:		{alertText		: 	'<s:Locale code="common.select.hintText" />'},
				del:		{conformText	: 	'<s:Locale code="common.delete.hintText" />'},
				grid:		{loadtext		:	'<s:Locale code="common.grid.loadtext" />',
							 loadnodata		:	'<s:Locale code="common.grid.loadnodata" />'},
				submit:		{conformText	:	'<s:Locale code="common.submit.hintText" />',
	...
	<!-- common js end   
	     common css begin  if browser is not msie 6.0,follow styles over ie 6.0 style -->
