...
(function(a){"function"===typeof define&&define.amd?define(["jquery","./jqdnr","./jqmodal"],a):"object"===typeof exports?a(require("jquery")):a(jQuery)})(function(a){function d(d,f,k){var g=l[d];m=a("#"+g.id).find("ul:first").clone(!0);m.css(g.menuStyle).find("li").css(g.itemStyle).hover(function(){a(this).css(g.itemHoverStyle)},function(){a(this).css(g.itemStyle)}).find("img").css({verticalAlign:"middle",paddingRight:"2px"});c.html(m);g.onShowMenu&&(c=g.onShowMenu(k,c));a.each(g.bindings,function(g,
d){a("#"+g,c).bind("click",function(){b();d(f,n)})});c.css({left:k[g.eventPosX],top:k[g.eventPosY]}).show();g.shadow&&e.css({width:c.width(),height:c.height(),left:k.pageX+2,top:k.pageY+2}).show();a(document).one("click",b)}function b(){c.hide();e.hide()}var c,e,m,l,n,h={menuStyle:{listStyle:"none",padding:"1px",margin:"0px",backgroundColor:"#fff",border:"1px solid #999",width:"100px"},itemStyle:{margin:"0px",color:"#000",display:"block",cursor:"default",padding:"3px",border:"1px solid #fff",backgroundColor:"transparent"},
itemHoverStyle:{border:"1px solid #0a246a",backgroundColor:"#b6bdd2"},eventPosX:"pageX",eventPosY:"pageY",shadow:!0,onContextMenu:null,onShowMenu:null};a.fn.contextMenu=function(b,f){c||(c=a('<div id="jqContextMenu"></div>').hide().css({position:"absolute",zIndex:"500"}).appendTo("body").bind("click",function(a){a.stopPropagation()}));e||(e=a("<div></div>").css({backgroundColor:"#000",position:"absolute",opacity:.2,zIndex:499}).appendTo("body").hide());l=l||[];l.push({id:b,menuStyle:a.extend({},h.menuStyle,
f.menuStyle||{}),itemStyle:a.extend({},h.itemStyle,f.itemStyle||{}),itemHoverStyle:a.extend({},h.itemHoverStyle,f.itemHoverStyle||{}),bindings:f.bindings||{},shadow:f.shadow||!1===f.shadow?f.shadow:h.shadow,onContextMenu:f.onContextMenu||h.onContextMenu,onShowMenu:f.onShowMenu||h.onShowMenu,eventPosX:f.eventPosX||h.eventPosX,eventPosY:f.eventPosY||h.eventPosY});var k=l.length-1;a(this).bind("contextmenu",function(a){var b=l[k].onContextMenu?l[k].onContextMenu(a):!0;n=a.target;if(b)return d(k,this,
a),!1});return this};a.contextMenu={defaults:function(b){a.each(b,function(b,c){"object"==typeof c&&h[b]?a.extend(h[b],c):h[b]=c})}}});$(function(){$("div.contextMenu").hide()});
