...
<script type="text/javascript">	
	...
	<div id="tool_box">
	 		<table   class="datatable">
 				<tr>
		 			<td width="120px"><s:Locale code="apps.category"/>:</td>
		 			<td width="374px">
	...
	<div class="mainwrap" id="main">
		<s:Grid id="list" url="/app/category/grid" multiselect="false" resize="true">	
			<s:Column width="0" field="id" title="id" hidden="true"/>
			<s:Column width="50" field="name" title="apps.category"/>
