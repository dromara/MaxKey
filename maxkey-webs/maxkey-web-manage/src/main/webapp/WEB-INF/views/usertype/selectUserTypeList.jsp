...
<script type="text/javascript">	
	...
	$(function () {
		$("#selectBtn").on("click",function(){
			...
			$(".userTypeId", window.parent.document).val(seldata.id);
			$(".userTypeName", window.parent.document).val(seldata.name);
			$.closeWindow();
...
<div>
	...
	<div class="mainwrap" id="main">
		<s:Grid id="list" url="/usertype/grid" multiselect="false" resize="false"  rowLimit="10">	
