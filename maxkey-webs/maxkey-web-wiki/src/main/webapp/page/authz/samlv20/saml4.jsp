...
<div id="container">
 <jsp:include page="/common/left.jsp">
 	<jsp:param value="authz-saml20-saml4" name="pageType"/>
 </jsp:include>
  <!-- treeView end -->
  <div class="content">
    <h1>SAML安全认证配置</h1>
   ...
   ConnSec SAML与自开发应用认证配置
    ...
    <div class="imgtxt">
       ...
       <pre>
        ...
        <h5>其步骤如下图所示:</h5>
        <img src="<%=path %>/images/saml/saml4_1.png" alt="JDK keytool工具生成证书">
        </div>
        
        
        <div class="imgtxt-img">
      <pre>在cmd.exe中输入命令：keytool -list -v -keystore d:\ConnSecsp.keystore -storepass secret，若结果如下图所示，则表明证书生成成功</pre>
        <img src="<%=path %>/images/saml/saml4_2.png" alt="JDK keytool工具生成证书">
        </div>
    </div>    
    </div>
    ...
    <div class="imgtxt">
        ...
        <div class="imgtxt-img">
        <h5>其步骤如下图所示:</h5>
        <img src="<%=path %>/images/saml/saml4_3.png" alt="生成配置">
        </div>
