...
<head>
	...
	<base href="<s:BasePath/>"/>
  	...
  	<script type="text/javascript" src="<s:Base/>/jquery/encrypt/jsbn.js"></script>
	<script type="text/javascript" src="<s:Base/>/jquery/encrypt/prng4.js"></script>
	<script type="text/javascript" src="<s:Base/>/jquery/encrypt/rng.js"></script>
	<script type="text/javascript" src="<s:Base/>/jquery/encrypt/rsa.js"></script>
	<script type="text/javascript" src="<s:Base/>/jquery/encrypt/base64.js"></script>
