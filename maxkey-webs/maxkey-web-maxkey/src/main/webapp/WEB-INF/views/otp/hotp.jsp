  ...
  <tr>
    <td>
	  <table   class="datatable" >
			<tbody>
			<tr>
				<td colspan="2">HOTP One Time Password</td>
			</tr>
			<tr>
				...
				<td  width="50%">
					<table   class="datatable">
						...
						<tr>
							<td colspan="2">
					    		<input class="button forward" style="width:100px" wurl="<c:url value="/otp/gen/hotp"/>"  type="button"    id="forward" value="<s:Locale code="button.text.save" />"/>
