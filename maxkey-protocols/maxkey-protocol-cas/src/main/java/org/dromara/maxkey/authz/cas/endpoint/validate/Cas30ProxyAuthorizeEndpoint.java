...
@Controller
public class Cas30ProxyAuthorizeEndpoint  extends CasBaseAuthorizeEndpoint{
    static final  Logger _logger = LoggerFactory.getLogger(Cas30ProxyAuthorizeEndpoint.class);
